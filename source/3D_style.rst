...
Поддерживаемые форматы данных: :term:`ESRI Shapefile` (zip-архив), :term:`GeoPackage`, :term:`GeoJSON`, :term:`GML`, :term:`KML`, :term:`CSV` или :term:`XLSX`. Для CSV и XLSX поддерживаются только точки, координаты должны быть в колонках lat и lon.
...
* Цвет в :term:`CSS` формате: название цвета (напр. red, blue) или код (напр. #0E1058)
...
* Цвет обводки в :term:`CSS` формате: название цвета (напр. red, blue) или код (напр. #0E1058)
